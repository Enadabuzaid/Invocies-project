...
@section('title')
    الصفحة الرئيسية -برناممج الفواتير
@stop
@section('css')
    <!--  Owl-carousel css-->
...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="left-content">
            <div>
                <h2 class="main-content-title tx-24 mg-b-1 mg-b-lg-1">Hi, welcome back! <span class="tx-orange">{{auth()->user()->name}}</span></h2>
                    ...
                    <div class="pb-0 mt-0">
                        <div class="d-flex">
                            <div class="">
                                ...
                                <p class="mb-0 tx-12 text-white op-7">{{\App\Models\invoice::count()}} <span>فاتورة</span></p>
                            </div>
                    ...
                    <div class="pb-0 mt-0">
                        <div class="d-flex">
                            <div class="">
                                ...
                                <p class="mb-0 tx-12 text-white op-7">{{\App\Models\invoice::where('Value_Status','=',2)->count()}} <span>فاتورة</span></p>
                            </div>
                            <span class="float-right my-auto mr-auto">
                    ...
                    <div class="pb-0 mt-0">
                        <div class="d-flex">
                            <div class="">
                                ...
                                <p class="mb-0 tx-12 text-white op-7">{{\App\Models\invoice::where('Value_Status','=',1)->count()}} <span>فاتورة</span></p>
                            </div>
                            <span class="float-right my-auto mr-auto">
											<i class="fas fa-arrow-circle-up text-white"></i>
                    ...
                    <div class="pb-0 mt-0">
                        <div class="d-flex">
                            <div class="">
                                ...
                                <p class="mb-0 tx-12 text-white op-7">{{\App\Models\invoice::where('Value_Status','=',3)->count()}} <span>فاتورة</span></p>
                            </div>
                            <span class="float-right my-auto mr-auto">
											<i class="fas fa-arrow-circle-down text-white"></i>
